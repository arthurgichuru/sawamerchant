...
class ScanNFCtoPay extends StatefulWidget {
  @override
  _ScanNFCtoPayState createState() => _ScanNFCtoPayState();
}

class _ScanNFCtoPayState extends State<ScanNFCtoPay> {
  String barcode = "";
  double payAmount =0;
      ...
      home: Scaffold(
        appBar: AppBar(
         backgroundColor: Color(0xff46b5d1),
          ...
          title: Text('Scan NFC to collect'),
        ),
        body: Container(
          child: ListView(
            children: <Widget>[
